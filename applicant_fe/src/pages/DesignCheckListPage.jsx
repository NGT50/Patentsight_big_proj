...
const DesignCheckListPage = () => {
  const navigate = useNavigate();

  const { data: patents, isLoading, isError, error } = useQuery({
    queryKey: ['myPatents', { type: 'DESIGN', status: 'DRAFT' }],
    queryFn: () => getMyPatents({ type: 'DESIGN', status: 'DRAFT' }),
  });
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="p-8">
        ...
        <div className="mt-8 space-y-4">
          ...
          {patents && patents.length === 0 && <p>임시저장된 디자인·상표가 없습니다.</p>}
